...
class QRcode
{
	...
	/**
	 * 生成二维码
	 * @param string $text         生成二位的的信息文本
	 * @param bool   $outfile      是否输出二维码图片 文件，默认否
	 * @param int    $level        容错率，也就是有被覆盖的区域还能识别，分别是 L（QR_ECLEVEL_L，7%），M（QR_ECLEVEL_M，15%），Q（QR_ECLEVEL_Q，25%），H（QR_ECLEVEL_H，30%）
